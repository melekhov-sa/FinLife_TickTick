...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "quick-add", label: "Быстрый ввод", href: "/quick-add", icon: Zap },
  { id: "budget", label: "Бюджет",  href: "/budget", icon: PieChart      },
  { id: "plan-accuracy", label: "Точность плана", href: "/plan-accuracy", icon: Target },
  { id: "debts",  label: "Долги",   href: "/debts",  icon: HandCoins     },
  ...
  { id: "media",      label: "Медиалог",   href: "/media",      icon: Clapperboard },
  { id: "collection",  label: "Коллекция",   href: "/collection",  icon: Gem      },
  { id: "flashcards",  label: "Флеш-карты",  href: "/flashcards",  icon: BookOpen },
